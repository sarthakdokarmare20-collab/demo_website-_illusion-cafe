...
/* =========================================
   ABOUT – LINE BY LINE PREMIUM ANIMATION
========================================= */
...
function runMainAboutAnimation(){
  ...
  lines.forEach(line=>{
    setTimeout(()=>{
      line.style.transition = "all .7s cubic-bezier(.22,.61,.36,1)";
...
/* run again when navigating back to HOME */
const originalOpenPage = openPage;
openPage = function(pageId){
  originalOpenPage(pageId);
  if(pageId === "home"){
    setTimeout(runHeroAnimation, 200);
  }
};
/* =====================================
   SCROLL REVEAL FOR HOME PAGE
===================================== */

function initScrollReveal(){

  const reveals = document.querySelectorAll(
    "#home .reveal, #home .reveal-img"
  );
...
const _openPageScroll = openPage;
openPage = function(pageId){
  _openPageScroll(pageId);
